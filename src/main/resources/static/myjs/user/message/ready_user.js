        ...
        success: function (dat) {
            ...
            for (var i = 0; i < data_length; i++) {
                ...
                text2 += '<div class="text-data-show">' +
                    ...
                    '<span class="data-main0"><a data-toggle="modal">' + dat.data[i].bnum + '</a></span>' +
                ...
                if (isEmpty(dat.data[i].state)) {
                    text2 += '<span class="data-main3" style="margin-left: 0;width:110px">等待反馈</span></span></div>'
                } else {
